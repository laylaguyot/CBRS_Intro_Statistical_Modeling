...
Note that R provides the 95% confidence interval in the output. Write a sentence to interpret it:
...
Write a sentence to interpret it:
...
```{r}
# Conduct the test
chisq.test(table(my_penguins$species, my_penguins$sex), correct = FALSE)
```
